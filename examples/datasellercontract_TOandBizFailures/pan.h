...
#define PanSource	"dataseller.pml"
...
#define _nstates1	834	/* CRM */
#define minseq1	637
#define maxseq1	1469
#define _endstate1	833

#define _nstates0	638	/* BEG */
#define minseq0	0
#define maxseq0	636
#define _endstate0	637
...
typedef struct P0 { /* BEG */
	...
	int numpaybizfail;
	int numrejbizfail;
	int numbuyreqbizfail;
	int numconfbizfail;
	int numcancbizfail;
	int numgetvoubizfail;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, numgetvoubizfail) - 1*sizeof(int))
...
typedef struct State {
	...
	#endif
#endif
	unsigned BuyRqFailBefore : 1;
	unsigned RejFailBefore : 1;
	unsigned ConfFailBefore : 1;
	unsigned PayFailBefore : 1;
	unsigned CancFailBefore : 1;
	unsigned GetVouFailBefore : 1;
	unsigned payNotification : 1;
	unsigned buyrj : 1;
	unsigned pay : 1;
	unsigned canc : 1;
	unsigned rejconfto : 1;
	unsigned paycancto : 1;
	unsigned paybizfail : 1;
	unsigned rejbizfail : 1;
	unsigned buyreqbizfail : 1;
	unsigned confbizfail : 1;
	unsigned cancbizfail : 1;
	unsigned getvoubizfail : 1;
	uchar cntttr;
	uchar BEG2CRM;
	uchar CRM2BEG;
	int BUYERexTrace;
	int STOREexTrace;
	struct BIS_OP BUYRQ_bo;
	struct BIS_OP REJ_bo;
	struct BIS_OP CONF_bo;
	struct BIS_OP PAY_bo;
	struct BIS_OP CANC_bo;
	struct BIS_OP GETVOU_bo;
	struct BIS_OP REJCONFTO_bo;
	struct BIS_OP PAYCANCTO_bo;
#ifdef TRIX
